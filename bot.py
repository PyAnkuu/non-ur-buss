...
MongoUrl='mongodb+srv://genequiz:genequiz@cluster0.b0bnroz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
# MongoDB connection
...
"""
    ...
    keyboard = InlineKeyboardMarkup([
        [InlineKeyboardButton("⛔️ Join channel", url="https://t.me/+lOTTg4cpII45Nzk9"),
         InlineKeyboardButton("Developer", url=f"https://t.me/{developer}")],
        [InlineKeyboardButton("📊 Check Status", callback_data="check_status"),InlineKeyboardButton("⛔️ Get Bot Code", url=f"https://t.me/+JM17kVCR6UZiMWNk")],
    ])
    ...
    await client.send_message(
        ...
        link_preview_options={"disable": True}
    )


    admin_chat_id = Logs_channel  # Replace with admin's chat ID
    notification_text = f"""
🆕 **New user started the bot Encoder Bot !**
...
async def handle_file(client, message):
    ...
    [
                ...
                [InlineKeyboardButton("⛔️ Get Bot Code", url=f"https://t.me/+JM17kVCR6UZiMWNk")]
